...
const Info = () => {
    return (
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-8/6">
            ...
            <InfoCard cardTitle="Our Location " bgClass="bg-neutral" img={location} cardText="Dhaka, Bangladesh"></InfoCard>
